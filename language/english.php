...
return [
    ...
    'index' => [
        ...
        'login' => [
            ...
            'no_user'    => 'User with this username not found',
            'wrong_pass' => 'Password is not correct',
...
define("_LEVELDELFAILED",
    "Error:<br /><br />Webadmin(s) with this level already exist(s)!<br />Level can not be deleted.");
...
define("_UPGRADE_FINISHED",
    "Your AMXBans Installation has been updated <b>successfully</b>.<br />Click 'Finish' to continue to your Admin Contol Panel.");
...
define("_SETUP_EXISTS",
    "<b>Security Alert!</b><br />setup.php still remains in your AMXBans Directory.<br /><br />You can still access the Admin Control Panel, but we strongly recommend you to remove it! ");
define("_BYTES", "bytes");
define("_MB", "MB");
