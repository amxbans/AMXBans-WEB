...
<head>
	...
	<link rel="stylesheet" href="{"setup.css"|res_url}" />
	<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
</head>
<body>
<header class="text-center">
	<a href="http://www.amxbans.net" target="_blank" class="_center"><img src="{'../templates/_gfx/amxbans.png'|res_url}" alt="AMXBans" />
	</a>
