CREATE TABLE `%name_admins_servers`
(
...
(
    level            SMALLINT   NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `%name_reasons_to_set`
(
  setid    SMALLINT NOT NULL,
  reasonid int      NOT NULL
);

CREATE TABLE `%name_serverinfo`
(
  id             SMALLINT     NOT NULL AUTO_INCREMENT,
